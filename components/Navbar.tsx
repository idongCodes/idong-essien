...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* 2. The Drawer */}
      <div 
        className={`fixed top-0 right-0 h-full w-1/2 bg-black border-l border-white/10 z-40 transform transition-transform duration-300 ease-in-out md:hidden pt-20 ${
