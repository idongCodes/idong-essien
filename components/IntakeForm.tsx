...
export default function IntakeForm() {
  ...
  if (isSubmitted) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center">
        ...
        <p className="text-gray-400 mb-8 max-w-md">Thank you for your interest. I will review your project details and get back to you shortly.</p>
        <Link href="/" className="bg-sky-blue text-black font-bold py-3 px-8 rounded-full hover:bg-sky-400 transition-all shadow-[0_0_15px_rgba(135,206,235,0.3)]">
          Return to Home
        </Link>
      </div>
    );
  ...
  return (
    <>
      <div className="mb-10">
        <Link href="/#work" className="inline-flex items-center gap-2 text-gray-400 hover:text-sky-blue transition-colors text-sm mb-8">
          <FaArrowLeft /> Back to Services
        </Link>
        <h1 className="text-3xl md:text-4xl font-bold text-white mb-3">Client Intake Form</h1>
        <p className="text-gray-400 font-light">Please provide as much detail as possible so I can understand your project and prepare a tailored proposal.</p>
      </div>
