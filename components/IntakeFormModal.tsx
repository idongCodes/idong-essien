            ...
            <form onSubmit={handleSubmit} className="space-y-10">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input required type="text" placeholder="Jane Doe" className="w-full bg-zinc-900 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-sky-blue transition-colors" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-gray-300">Email Address *</label>
                    <input required type="email" placeholder="jane@example.com" className="w-full bg-zinc-900 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-sky-blue transition-colors" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-gray-300">Company / Brand Name</label>
                    <input type="text" placeholder="Acme Corp" className="w-full bg-zinc-900 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-sky-blue transition-colors" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-gray-300">Current Website URL (if any)</label>
                    <input type="url" placeholder="https://yourwebsite.com" className="w-full bg-zinc-900 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-sky-blue transition-colors" />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <select required className="w-full bg-zinc-900 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-sky-blue transition-colors appearance-none">
                    <option value="" disabled selected>Select a project type...</option>
                    <option>Bespoke Website (Portfolio, Business, E-commerce)</option>
                    <option>Progressive Web App (PWA) / Mobile Experience</option>
                    <option>Internal Software / Digital Tool (Dashboards, Automations)</option>
                    <option>SEO Optimization / Website Revamp</option>
                    <option>Other</option>
                  </select>
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-medium text-gray-300">Please describe the project in a few sentences *</label>
                  <textarea required rows={4} placeholder="We need a PWA for our customers to order products directly from their phones..." className="w-full bg-zinc-900 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-sky-blue transition-colors resize-none"></textarea>
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-medium text-gray-300">What are the core features this project MUST have?</label>
                  <input type="text" placeholder="e.g. User login, Stripe payments, Booking system" className="w-full bg-zinc-900 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-sky-blue transition-colors" />
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input type="text" placeholder="Local homeowners aged 30-50" className="w-full bg-zinc-900 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-sky-blue transition-colors" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-gray-300">What does a successful outcome look like?</label>
                    <input type="text" placeholder="Increase monthly leads by 30%" className="w-full bg-zinc-900 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-sky-blue transition-colors" />
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <select required className="w-full bg-zinc-900 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-sky-blue transition-colors appearance-none">
                      ...
                      <option>$1,500 - $3,000 (Basic Websites)</option>
                      <option>$3,000 - $6,000 (Advanced Sites / Simple Apps)</option>
                      <option>$6,000 - $10,000+ (Complex Internal Software / PWAs)</option>
                    </select>
                  </div>
                  <div className="space-y-2">
                    ...
                    <select required className="w-full bg-zinc-900 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-sky-blue transition-colors appearance-none">
                      ...
                      <option>ASAP (Rush fee may apply)</option>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <textarea rows={3} placeholder="https://stripe.com - Love the clean design and animations..." className="w-full bg-zinc-900 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-sky-blue transition-colors resize-none"></textarea>
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-medium text-gray-300">Links to hosted assets (Pictures, Videos, Logos)</label>
                  <textarea rows={2} placeholder="Google Drive, Dropbox, or Imgur links to media you want included..." className="w-full bg-zinc-900 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-sky-blue transition-colors resize-none"></textarea>
              ...
              <div className="pt-6 border-t border-white/10">
                <button type="submit" className="w-full bg-sky-blue text-black font-bold text-lg py-4 rounded-xl hover:bg-sky-400 hover:scale-[1.01] transition-all shadow-[0_0_20px_rgba(135,206,235,0.2)]">
